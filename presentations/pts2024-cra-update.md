...
* Intro: Scout vs. Soldier mindset
* Goal: Explore and learn the landscape, so we can update our maps
* Method: List sources; Share confidence %
* Priorities: Facts from law, then consequences, then our responses
...
> * Product with Digital Elements: CRA Article 3 (1), (4), (6), (7)
> * Placing on the market: CRA Article 3 (21), (22)
...
* Security fixes must remain available for 10 years afted publishing (Article 13 point 9)
...
* Describe how their product is put together ([Annex VII point 2 (a)](https://www.europarl.europa.eu/doceo/document/TA-9-2024-0130_EN.pdf#page=314))
