...
However, in April 2026 the Perl NOC [announced](https://log.perl.org/2026/04/cpanorg-email-forwarding-has-been-shut.html) that cpan.org email forwarding had been shut down.
...
In addition the Perl NOC stated that over 99% of the mail sent to cpan.org addresses was spam.

## What this means

Messages sent to your @cpan.org address will now bounce.
It is important that you update your contact information so you can be contacted for bugs or vulnerabilities.
...
### Add a .mailmap File to Your Repository
...
Add a standard [.mailmap](https://git-scm.com/docs/gitmailmap) file to the root of your repository. This file maps your old @cpan.org commit email to your current public address, ensuring commit history and toolchains credit you correctly without displaying broken contact info.

Example .mailmap file

```
Firstname Lastname  <proper@email.xx> <commit@email.xx>

```
### Make Your PAUSE Private Email Public
