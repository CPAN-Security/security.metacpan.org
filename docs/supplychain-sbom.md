...
graph TB
    ...
    monetised -->|Yes| cra-manufacturer(CRA is in-scope<br>You are a Manufacturer)
    ...
    product-supporter -->|Yes| cra-oss-steward(CRA in-scope<br>You are an Open-Source Steward)
